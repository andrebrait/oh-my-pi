...
- Reinstalling an npm plugin no longer drops it from `plugins/package.json` when bun rewrites no manifest edge, so a forced reinstall of the installed version survives the next install ([#12861](https://github.com/can1357/oh-my-pi/pull/12861) by [@andrebrait](https://github.com/andrebrait)).
